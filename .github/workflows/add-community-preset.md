...
exact, case-sensitive prefix `[Preset]:`, continue to Step 1 regardless of
...
> This workflow was triggered by `preset-submission`, but the issue title
> does not start with `[Preset]:`. This workflow has not run catalog
