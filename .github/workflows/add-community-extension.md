...
exact, case-sensitive prefix `[Extension]:`, continue to Step 1 regardless of
...
> This workflow was triggered by `extension-submission`, but the issue title
> does not start with `[Extension]:`. This workflow has not run catalog
